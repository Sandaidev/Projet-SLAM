...
CREATE TABLE `commande` (
  ...
  `statusCommande` int(11) NOT NULL,
...
CREATE TABLE `utilisateur` (
  ...
  `statusUtilisateur` int(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `utilisateur` (`idUtilisateur`, `login`, `motDePasse`, `niveauAutorisation`, `statusUtilisateur`) VALUES
(1, 'root', '$2y$10$u0UVhSpwyu2pAGvaXgh5yunsQ211SYjCTzh/JcdarHfVsWXyd.yeu', 1, 1);
...
ALTER TABLE `commande`
  ...
  ADD KEY `FK_commande_idEntreprise` (`idEntreprise`);
...
ALTER TABLE `detailCommande`
  ...
  ADD KEY `FK_detailCommande_idProduit` (`idProduit`);
...
ALTER TABLE `produit`
  ...
  ADD KEY `FK_produit_idTVA` (`idTVA`);
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `FK_commande_idEntreprise` FOREIGN KEY (`idEntreprise`) REFERENCES `entreprise` (`idEntreprise`);

--
-- Constraints for table `detailCommande`
--
ALTER TABLE `detailCommande`
  ADD CONSTRAINT `FK_detailCommande_idCommande` FOREIGN KEY (`idCommande`) REFERENCES `commande` (`idCommande`),
  ADD CONSTRAINT `FK_detailCommande_idProduit` FOREIGN KEY (`idProduit`) REFERENCES `produit` (`idProduit`);
...
ALTER TABLE `produit`
  ...
  ADD CONSTRAINT `FK_produit_idTVA` FOREIGN KEY (`idTVA`) REFERENCES `tva` (`idTVA`);
COMMIT;
